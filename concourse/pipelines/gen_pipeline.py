...
CWD = os.getcwd()
SECRETS_PATH = os.path.expanduser(CWD + '/../vars')
...
def print_fly_commands(args, git_remote, git_branch):
    ...
    if args.directed_release: 
        ...
        print(gen_pipeline(args, pipeline_name, ["without_asserts_common_prod.yml"],
    ...
    if args.pipeline_target == 'prod':
        ...
        print(gen_pipeline(args, "%s_without_asserts" % pipeline_name, ["without_asserts_common_prod.yml"],
                           "https://github.com/greenplum-db/gpdb.git", BASE_BRANCH))
        return

    print('NOTE: You can set the developer pipeline with the following:\n')
    print(gen_pipeline(args, pipeline_name, [], git_remote, git_branch))
